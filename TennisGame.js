...
var TennisGame = /** @class */ (function () {
    function TennisGame(player1Name, player2Name, player1_Score, player2_Score) {
        this.score = '';
    ...
    TennisGame.prototype.getScore = function () {
        if (this.player1_Score == this.player2_Score) {
            ...
            this.scoreDuringGame();
    };
    TennisGame.prototype.setTieScoreGame = function () {
    ...
    TennisGame.prototype.checkWin = function () {
    ...
    TennisGame.prototype.scoreDuringGame = function () {
        for (var i = 1; i < 3; i++) {
            if (i === 1)
                this.tempScore = this.player1_Score;
            else {
                this.score += "-";
